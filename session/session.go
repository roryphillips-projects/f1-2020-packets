...
type Packet struct {
	...
	Weather common.WeatherType `json:"weather" packet:"0"`
	...
	Session common.SessionType `json:"session" packet:"5"`
	// Track track this session is in
	Track common.TrackType `json:"track" packet:"6"`
	// Formula formula this session uses
	Formula common.FormulaType `json:"formula" packet:"7"`
...
type MarshalZone struct {
	...
	ZoneFlag common.ZoneFlag `json:"zone_flag" packet:"1"`
}
